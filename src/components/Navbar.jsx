    ...
    <nav className="px-4 sm:px-6 md:px-8 py-4 sm:py-5 bg-linear-to-r from-[#38175A] to-[#2a1044] shadow-2xl border-b border-[#4a1f6e] name">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        <div className="flex items-center gap-2 sm:gap-3">
          <div className="w-10 h-10 sm:w-12 sm:h-12 bg-linear-to-br from-[#D6B9FC] to-[#838CE5] rounded-xl flex items-center justify-center shadow-lg">
            <i className="fa-solid fa-box text-[#2a1044] text-lg sm:text-xl"></i>
          </div>
        ...
        <div className="hidden md:flex items-center gap-4 lg:gap-6">
          ...
          <a 
            href="/retrieve" 
            className={`font-medium px-4 lg:px-6 py-2 rounded-lg transition-colors duration-200 text-sm lg:text-base ${
