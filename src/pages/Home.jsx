export default function Home() {
  return (
    <div className="flex flex-col items-center justify-center text-center min-h-[calc(100vh-80px)] px-6 overflow-hidden home-container" style={{ fontFamily: "'Inter', 'Segoe UI', system-ui, sans-serif" }}>
